...
public class PetaExpressService {

    private EnvContext envContext;

    private String zone;

    public PetaExpressService(EnvContext envContext) {
        this.envContext = envContext;
    }

    public PetaExpressService(EnvContext envContext, String zone) {
        this.envContext = envContext;
        this.zone = zone;
    }
    ...
    /**
      ...
      *
      * <a href=https://docs.petaexpress.com/api/zone/describe_zones.html>Documentation URL</a>
      */
