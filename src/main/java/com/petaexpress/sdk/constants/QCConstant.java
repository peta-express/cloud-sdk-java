...
package com.petaexpress.sdk.constants;
...
public class QCConstant {
    ...
    public static final String SDK_NAME = "petaexpress-sdk-java";
    ...
    public static final String DEFAULT_HOST = "api.petaexpress.com";
